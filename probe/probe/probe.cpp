...
int main()
{
    ...
    const int N = 12;
    int vec_nosort[N] = { 22,999,1,5,250,115,777,-5,33,620,16,123 }; //изменили 0 на 16
    int vec_sort[N] = { -5,16,1,5,22,115,123,250,33,620,777,999 };  // тут тоже изменили 0 на 16
    int number;
