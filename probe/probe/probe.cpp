...
int main()
{
    ...
    int vec_nosort[N] = { 22,99,1,5,250,115,77,-5,33,620,16,123 }; //изменили 333 на 33
    int vec_sort[N] = { -5,16,1,5,22,115,123,250,33,620,77,99 };  // тут тоже изменили 333 на 33
